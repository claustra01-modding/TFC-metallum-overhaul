...
public final class Tfcmu2OreVeinModifierCore {
    ...
    private Tfcmu2OreVeinModifierCore() {
    }

    public static void modify(boolean isNether, boolean isEnd, List<Holder<PlacedFeature>> ores,
                              List<Holder<PlacedFeature>> extra, Registry<PlacedFeature> placedFeatures,
                              boolean customVeinsEnabled) {
    ...
    private static ResourceLocation id(String namespace, String path) {
        return Tfcmu2Platform.id(namespace, path);
    }
}
