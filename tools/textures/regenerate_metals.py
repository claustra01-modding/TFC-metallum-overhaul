...
ORIGINAL_MOD_SOURCES = {
    ...
    "boron": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/boron.png",
    ),
    "thorium": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/thorium.png",
    ),
    "magnesium": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/magnesium.png",
    ),
    "beryllium": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/beryllium.png",
    ),
    "zirconium": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/zirconium.png",
    ),
    "ferroboron": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/ferroboron.png",
    ),
    "tough_alloy": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/tough_alloy.png",
    ),
    "zircaloy": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/zircaloy.png",
    ),
    "hsla_steel": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/hsla_steel.png",
    ),
    "super_alloy": (
        NUCLEARCRAFT_JAR,
        "assets/nuclearcraft/textures/item/material/ingot/super_alloy.png",
    ),
}
...
METAL_FORM_BASES = {
    ...
    "beryllium": "silver",
    "zirconium": "steel",
    "neutronium": "black_steel",
    "ferroboron": "black_steel",
    "tough_alloy": "black_steel",
    "zircaloy": "steel",
    "hsla_steel": "black_steel",
    "super_alloy": "black_steel",
}
...
def source_pixels(metal: str) -> list[tuple[int, int, int, int]]:
    ...
    if metal in NUCLEARCRAFT_METALS and metal != "neutronium":
        return load_zip_png(*ORIGINAL_MOD_SOURCES[metal])[1]
...
def main() -> None:
    ...
    # Neutronium is generated by regenerate_neutronium.py because its source
    # palette is a multi-frame animated PNG rather than a single 16x16 image.
    existing_metals = {
        path.stem
        for path in ingot_dir.glob("*.png")
        if path.stem not in {"neutronium", "high_carbon_tungsten_steel"}
    }
    metals = sorted(existing_metals | (NUCLEARCRAFT_METALS - {"neutronium"}))
