...
public enum Tfcmu2ArmorMaterials implements ArmorMaterial, PhysicalDamageType.Multiplier {
    ...
    Tfcmu2ArmorMaterials(String name, TFCArmorMaterials delegate, float durabilityScale, int defenseBonus) {
        this.name = name;
