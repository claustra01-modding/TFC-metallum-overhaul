...
public final class Tfcmu2ArmorMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, Tfcmu2Mod.MOD_ID);
    ...
    private static ArmorSet register(String name, int bootsDurability, int leggingsDurability, int chestplateDurability, int helmetDurability,
        ...
        final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(Tfcmu2Mod.MOD_ID, name);
