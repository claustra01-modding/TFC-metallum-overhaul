...
public enum Tfcmu2Metal implements RegistryMetal {
    ...
    ALUMINUM("aluminum", Rarity.COMMON, 0x6D7273),
    CONSTANTAN("constantan", Rarity.COMMON, 0xB3634F),
    ELECTRUM("electrum", Rarity.UNCOMMON, 0xC39857),
    LEAD("lead", Rarity.COMMON, 0x4C5162),
    URANIUM("uranium", Rarity.UNCOMMON, 0x627058),
