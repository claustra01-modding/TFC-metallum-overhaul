...
public final class Tfcmu2OreVeinBiomeModifier implements BiomeModifier {
    ...
    private static final TagKey<Biome> IS_NETHER = TagKey.create(
        Registries.BIOME, Tfcmu2Platform.id("minecraft", "is_nether")
    );
    private static final TagKey<Biome> IS_END = TagKey.create(
        Registries.BIOME, Tfcmu2Platform.id("minecraft", "is_end")
    );
    ...
    public void modify(Holder<Biome> biome, Phase phase, ModifiableBiomeInfo.BiomeInfo.Builder builder) {
        ...
        Tfcmu2OreVeinModifierCore.modify(
            biome.is(IS_NETHER), biome.is(IS_END), ores, extra, placedFeatures,
            Tfcmu2Config.COMMON.enableCustomVeinGeneration.get()
        );
    }
