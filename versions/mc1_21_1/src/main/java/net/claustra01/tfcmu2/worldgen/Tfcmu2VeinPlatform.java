...
final class Tfcmu2VeinPlatform {
    private Tfcmu2VeinPlatform() {
    }
    ...
    static VeinConfig createVeinConfig(
        ...
        return new VeinConfig(states, indicator, rarity, density, minY, maxY, project, projectOffset, seed, nearLava);
    }
}
